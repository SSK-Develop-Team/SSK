...
<title>ADMIN HOME - 전문가 계정 관리</title>
<style>
</style>
</head>
<body>
<%@ include file = "sidebar.jsp" %>
<div class="w3-margin" style="font-weight:bold;font-size:20px;padding-left:25px;"><img src="./image/manage.png" style="width:20px;">     전문가 계정 관리</div>
<div style="width:100%;">
...
<div class="buttons" style="width:100%;">
	<button class="w3-button w3-right" onclick="location.href='../ssk/register.jsp?role=expert';">계정 생성</button>
