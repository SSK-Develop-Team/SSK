	...
	<div class="w3-col w3-container s12 m10 l6">
		...
		<div>
			<div class="oceanBack1">
				...
				<img class="selectImg01" src="./image/LangGameImg/Age10/age10_2_1_icon01.png" width="4%" alt="작은 문어" onclick="document.getElementById('answer-modal').style.display='block';document.getElementById('answer-audio').autoplay();" />
					<div id="select-modal01" class="w3-modal">
						<div class="w3-modal-content w3-animate-opacity w3-round-large" style="width:40vw;height: 40vh;">
							...
							<img src="./image/LangGameImg/Age10/age10_2_1_modal01.png">
							</div>
						</div>
					</div>
