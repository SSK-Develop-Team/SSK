...
<%
	...
	ArrayList<String> test_list = new ArrayList<String>();
		...
		test_list.add("'나는 간식, 학용품, 또는 나의 것을 기꺼이 다른 친구들과 함께 나눈다.'");
		test_list.add("'나는 누군가가 다치거나, 아프거나 힘들어 보이면 도움을 준다.'");
		test_list.add("'나는 안절부절 못하고 차분하지 않으며 오랫동안 가만히 있지 못한다.'");
		test_list.add("'나는 쉽게 산만해지고, 집중하기 어렵다.'");
		test_list.add("'나는 낯선 상황에서 긴장하거나 불안해하고 쉽게 자신감을 잃는다.'");
		test_list.add("'나는 두려움이 많고 무서움을 잘 탄다.'");
		test_list.add("'나는 친구들과 자주 싸우거나 친구를 괴롭히는 편이다.'");
		test_list.add("'나는 종종 거짓말을 하거나 속인다.'");
		test_list.add("'나는 친구들과 함께 있기 보다는 주로 홀로 있고, 혼자서 노는 편이다.'");
		test_list.add("'나는 친구들이 대체로 나를 좋아한다.'");
%>
...
<head>
<meta charset="UTF-8">
<title>esm test child version</title>
<style>
	.btn{
