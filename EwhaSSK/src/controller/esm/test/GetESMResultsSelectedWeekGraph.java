...
@WebServlet("/GetESMResultsSelectedWeekGraph")
public class GetESMResultsSelectedWeekGraph extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public GetESMResultsSelectedWeekGraph() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 오늘 기준 주 간격
		int indexOfWeek = Integer.parseInt(request.getParameter("indexOfWeek"));
